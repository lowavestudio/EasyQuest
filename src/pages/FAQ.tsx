...
const FAQ_SECTIONS: FaqSection[] = [
    ...
    },
    {
        ...
        items: [
            ...
            {
                q: 'Что такое VIP-задание?',
                a: 'VIP-задание — это приоритетное размещение вашей заявки за дополнительные 50 Stars. Такие задания всегда отображаются выше в ленте и выделяются ярким золотым цветом с короной 👑. Они сразу привлекают внимание и обычно выполняются значительно быстрее.',
            },
            {
        ...
        items: [
            {
                ...
                a: 'Напишите нам в Telegram: @EasyQuestSupportBot\nМы отвечаем в рабочие дни с 9:00 до 21:00 (МСК).\n\nОписывайте проблему подробно — приложите скриншот, ID задания и суть вопроса.',
            },
            {
                q: 'Как оставить пожелание или сообщить об ошибке?',
                a: 'Мы открыты к предложениям! Напишите в @EasyQuestSupportBot с темой «Предложение» или «Баг». Лучшие идеи от пользователей попадают в следующие обновления.',
            },
        ],
    },
];
        ...
        <div className="task-details-page">
            ...
            <div style={{ padding: '16px', display: 'flex', flexDirection: 'column', gap: '16px', paddingBottom: '32px' }}>
                ...
                <div style={{
                    ...
                    <a
                        href="https://t.me/EasyQuestSupportBot"
                        target="_blank"
